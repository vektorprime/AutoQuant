...
def _quantize_one_layer_q4k(layer: nn.Linear, quants_delta_K: int = 256, sm_share_K: int = 8, d_share_K: int = 8) -> dict:
...
def parse_args():
    ...
    parser.add_argument("--sm-share-K", type=int, default=8,
